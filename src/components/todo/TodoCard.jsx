...
const TodoCard = ({ title, description, updateAt, createAt, status }) => {
    return (
        <>
            <div className="max-h-30  bg-white rounded-lg shadow-md border p-5 cursor-pointer hover:bg-slate-100 transition duration-150 ease-out hover:ease-in">
